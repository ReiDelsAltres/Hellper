...
let fireContainer: HTMLDivElement | null = null;
...
function createFireContainer(): HTMLDivElement {
...
function createEmber(container: HTMLDivElement): Ember {
...
function animateFire(): void {
    for (const ember of embers) {
        ...
        if (ember.x > window.innerWidth) ember.x = 0;
        if (ember.x < 0) ember.x = window.innerWidth;

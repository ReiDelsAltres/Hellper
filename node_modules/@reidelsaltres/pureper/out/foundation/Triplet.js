...
export class TripletBuilder {
    ...
    static create(markup, css, js) {
        let urlHtml = markup ? new URL(markup, window.location.href) : null;
        let urlCss = css ? new URL(css, window.location.href) : null;
        let urlJs = js ? new URL(js, window.location.href) : null;

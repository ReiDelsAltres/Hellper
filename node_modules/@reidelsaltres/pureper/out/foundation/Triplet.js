...
export class TripletBuilder {
    ...
    static create(markup, css, js) {
        let urlHtml = markup ? new URL(`${HOSTING_ORIGIN}/${markup}`, HOSTING_ORIGIN) : null;
        let urlCss = css ? new URL(`${HOSTING_ORIGIN}/${css}`, HOSTING_ORIGIN) : null;
        let urlJs = js ? new URL(`${HOSTING_ORIGIN}/${js}`, HOSTING_ORIGIN) : null;

...
export default class SvgIcon extends Component {
     ...
     */
    initializeElements(holder) {
        const tt = holder.element.innerHTML;
        this.svgElement = holder.element.querySelector('.svg-icon');
        this.containerElement = holder.element.querySelector('.svg-container');
    ...
    clearColorClasses() {
        if (!this.svgElement)
            return;
        this.svgElement.classList.remove('color-primary', 'color-secondary', 'color-tertiary', 'color-success', 'color-warning', 'color-error', 'color-info', 'color-text');
    }
    /**
     * Проверка валидности цвета
     */
    isValidColorVariant(color) {
...
//# sourceMappingURL=SvgIcon.html.js.map